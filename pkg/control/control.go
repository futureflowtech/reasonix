...
// AutoPlanClassifier decides whether a turn needs a plan.
type AutoPlanClassifier = ictrl.AutoPlanClassifier

// ProviderAutoPlanClassifier is a built-in classifier using a provider.
type ProviderAutoPlanClassifier = ictrl.ProviderAutoPlanClassifier
